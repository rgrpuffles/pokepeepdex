...
import { cardSections, defaultSetId, emptyGallerySet } from '../../models/gallery.models';
import { GalleryDataService } from '../../services/gallery-data.service';
import * as i0 from "@angular/core";
const _forTrack0 = ($index, $item) => $item.key;
const _forTrack1 = ($index, $item) => $item.src;
function SetGalleryComponent_For_27_For_8_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵdomElementStart(0, "figure", 11);
...
function SetGalleryComponent_For_27_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵdomElementStart(0, "section", 6)(1, "div", 7)(2, "p", 8);
    i0.ɵɵtext(3);
    i0.ɵɵdomElementEnd();
    i0.ɵɵdomElementStart(4, "span", 9);
    i0.ɵɵtext(5);
    i0.ɵɵdomElementEnd()();
    i0.ɵɵdomElementStart(6, "div", 10);
    i0.ɵɵrepeaterCreate(7, SetGalleryComponent_For_27_For_8_Template, 4, 3, "figure", 11, _forTrack1);
    i0.ɵɵdomElementEnd()();
} if (rf & 2) {
    const section_r2 = ctx.$implicit;
    i0.ɵɵnextContext();
    const currentSet_r3 = i0.ɵɵreadContextLet(0);
    const cards_r4 = currentSet_r3.cards[section_r2.key];
    i0.ɵɵadvance(3);
    i0.ɵɵtextInterpolate(section_r2.label);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1("", cards_r4.length, " cards");
    i0.ɵɵadvance(2);
    i0.ɵɵrepeater(cards_r4);
} }
export class SetGalleryComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: SetGalleryComponent, selectors: [["app-set-gallery"]], decls: 28, vars: 11, consts: [[1, "set-page"], [1, "hero"], [1, "hero-copy"], [1, "kicker"], [1, "summary"], ["aria-label", "Set stats", 1, "stat-strip"], [1, "section"], [1, "section-head"], [1, "section-label"], [1, "section-count"], [1, "card-grid"], [1, "card"], ["loading", "lazy", "decoding", "async", 3, "src", "alt"]], template: function SetGalleryComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵtext(25);
            i0.ɵɵdomElementEnd()()()();
            i0.ɵɵrepeaterCreate(26, SetGalleryComponent_For_27_Template, 9, 2, "section", 6, _forTrack0);
            i0.ɵɵdomElementEnd();
        } if (rf & 2) {
            const currentSet_r5 = i0.ɵɵstoreLet(ctx.set());
            const visibleSections_r6 = ctx.sectionsWithCards();
            i0.ɵɵadvance();
            i0.ɵɵstyleProp("--accent", currentSet_r5.accent)("--accent-soft", currentSet_r5.accentSoft)("--glow", currentSet_r5.glow);
            i0.ɵɵadvance(6);
            i0.ɵɵtextInterpolate(currentSet_r5.title);
            i0.ɵɵadvance(8);
            i0.ɵɵtextInterpolate(ctx.totalCards());
            i0.ɵɵadvance(5);
            i0.ɵɵtextInterpolate(visibleSections_r6.length);
            i0.ɵɵadvance(5);
            i0.ɵɵtextInterpolate(currentSet_r5.slug);
            i0.ɵɵadvance();
            i0.ɵɵrepeater(visibleSections_r6);
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(SetGalleryComponent, [{
        type: Component,
        args: [{ selector: 'app-set-gallery', standalone: true, template: `
    @let currentSet = set();
    @let visibleSections = sectionsWithCards();
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(SetGalleryComponent, { className: "SetGalleryComponent", filePath: "app/pages/set-gallery/set-gallery.component.ts", lineNumber: 76 }); })();
